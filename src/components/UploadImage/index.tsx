...
const transparentBg = require('../../assets/images/transparentBg.png').default
...
const UploadImage = (props: UploadImageProps) => {
	...
	const beforeUpload = (file: any, fileList: any[]): Promise<any> | {} => {
		...
		return new Promise(async (resolve, reject) => {
			const data: any = await dispatchWithPromise({ type: GET_QI_NIU_TOKEN });
			setToken(data.token);
	...
	return (
		<div>
			...
			<Modal
				...
				footer={false}
			>
				<div style={{ background: props.isShowBg ? `url(${transparentBg}) no-repeat` : '', backgroundSize: "100% 100%" }}>
